...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      'fixed top-4 z-[100] flex max-h-screen w-full flex-col-reverse p-2 sm:bottom-auto sm:right-4 sm:top-4 sm:flex-col md:max-w-[320px]',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      'absolute right-1.5 top-1.5 rounded-md p-0.5 text-white/40 opacity-0 transition-opacity hover:text-white/80 focus:opacity-100 focus:outline-none group-hover:opacity-100 group-[.destructive]:text-red-300 group-[.destructive]:hover:text-red-100',
      className,
    )}
    toast-close=""
    {...props}
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title
    ref={ref}
    className={cn('text-xs font-semibold text-white/90', className)}
    {...props}
  />
))
